...
impl<'a> ObjetoMapa for BombaNormal<'a> {
    ...
    fn detonar(&mut self) -> Result<(), String> {
        ...
        for i in 1..self.alcance + 1 {
            ...
            self.juego
                .rafagear_coordenada(&coordenada_derecha_a_rafagear);
            self.juego
                .rafagear_coordenada(&coordenada_izquierda_a_rafagear);
            self.juego
                .rafagear_coordenada(&coordenada_arriba_a_rafagear);
            self.juego.rafagear_coordenada(&coordenada_abajo_a_rafagear);
        }
